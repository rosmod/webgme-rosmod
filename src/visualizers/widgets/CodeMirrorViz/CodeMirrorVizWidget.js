...
define(['css!./styles/CodeMirrorVizWidget.css'], function () {
    'use strict';

    var CodeMirrorVizWidget,
        WIDGET_CLASS = 'code-mirror-viz';

    CodeMirrorVizWidget = function (logger, container) {
    ...
    CodeMirrorVizWidget.prototype._initialize = function () {
        ...
        this._el.append('<h3>CodeMirrorViz Events:</h3>');
